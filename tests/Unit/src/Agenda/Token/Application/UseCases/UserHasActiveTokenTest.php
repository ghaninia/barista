...
use Src\Agenda\Token\Application\UseCases\Queries\UserHasActiveTokenUseCase;
...
class UserHasActiveTokenTest extends TestCase
{
    /** @test */
    public function UserHasActiveTokenUseCase()
    {
        ...
        $result = new UserHasActiveTokenUseCase($user, $type);
